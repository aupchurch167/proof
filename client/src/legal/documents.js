// Keep versions in lockstep with server/src/legal/documents.js when counsel
// swaps the bodies. These pages are DRAFT placeholders, not legal advice.

export const TERMS_VERSION = 'draft-2026-09-21';
export const PRIVACY_VERSION = 'draft-2026-09-21';
